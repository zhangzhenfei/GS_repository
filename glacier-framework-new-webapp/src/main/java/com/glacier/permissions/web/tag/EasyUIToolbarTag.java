package com.glacier.permissions.web.tag;
...
public class EasyUIToolbarTag extends TagSupport {
    ...
    public int doStartTag() throws JspException {
        try {
            ...
            sqlStr.append("temp_action.panel_id as temp_action_panel_id, temp_action.auth_range as temp_action_auth_range, ");
            sqlStr.append("temp_action.default_action as temp_action_default_action, temp_action.action_cn_name as temp_action_action_cn_name, ");
            ...
            while (rs.next()) {// 遍历返回数据，进行字符串构造
                ...
                actionTemp.setAuthRange(ActionAuthRange.valueOf(rs.getString("temp_action_auth_range")));
                actionTemp.setDefaultAction(DefaultAction.valueOf(rs.getString("temp_action_default_action")));
                ...
                if (subject.isPermitted(permissionStr)  && !actionTemp.getDefaultAction().getValue()) {// 权限验证通过
